...
def fetch_meme_string():
    headers = {
        ...
        'cookie': 'iflipsess=epm7uo84gh3d8j39mef9amd85i',
    }

    post_request = 'use_openai=0&meme_id=438680&init_text=&__tok=8MsJsQX8T73%2FZw%2BDBt1fGlxyd78f0RXqB34rp%2FyRakg%3D&__cookie_enabled=1'
